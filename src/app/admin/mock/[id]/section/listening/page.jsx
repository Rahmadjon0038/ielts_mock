...
export default function ListeningForm() {
  ...
  const addTask = (sectionIndex, questionIndex, taskType) => {
    ...
    const newTask = {
      ...
      type: taskType,
      question: "",
      // 'text' uchun options bo'sh, 'radio', 'select', 'checkbox' uchun kamida ikkita bo'sh variant
                          ...
                          <TaskCard key={taskIndex}>
                                ...
                                <OptionsList>
                                  {task.options?.map((option, optionIndex) => (
                                    <OptionInput key={optionIndex}>
                                      {/* Variant harfi (A, B, C...) olib tashlandi */}
                                      <OptionText
                                        value={option}
                                        onChange={(e) =>
                                          updateOption(
                            ...
                            <FormGroup>
                              <Label>
                                To'g'ri Javob
                                {task.type === "checkbox" && (
                                    <span style={{ color: "#d53f8c", fontSize: "0.8em", marginLeft: "10px" }}>
                                        (Vergul bilan ajratilgan: Masalan, A, C)
                                    </span>
                                )}
                              </Label>
                              <Input
                                ...
                                placeholder={task.type === "checkbox" ? "Masalan: A, C" : "A, B, C, D yoki javob matni/raqami"}
                              />
                            </FormGroup>
                          </TaskCard>
                        ))}
                      ...
                      <ButtonGroup>
                        ...
                        >
                         ...
                         <Button
                          ...
                          secondary
                          onClick={() =>
                            addTask(sectionIndex, questionIndex, "checkbox")
                          }
                        >
