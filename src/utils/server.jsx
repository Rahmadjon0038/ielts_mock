...
,
    ...
    {
  "part": "part2",
  "intro": "O‘qishga asoslangan 20-24 savollarga taxminan 15 daqiqa vaqt ajrating.",
  "textTitle": "Evolution of Feathered Dinosaurs",
  "text": "Recent fossil discoveries in China have provided compelling evidence for the evolutionary link between dinosaurs and birds...",
  "question": [
    {
      "questionTitle": "Questions 20-21",
      "questionIntro": "Quyidagi har bir bayonot uchun to‘g‘ri javobni tanlang.",
      "questionsTask": [
        {
          "number": 20,
          "type": "radio",
          "question": "Feathers found on some dinosaurs were originally used for flight.",
          "options": ["TRUE", "FALSE", "NOT GIVEN"]
        },
        {
          "number": 21,
          "type": "radio",
          "question": "China has become a key location for feathered dinosaur fossils.",
          "options": ["TRUE", "FALSE", "NOT GIVEN"]
        }
      ]
    },
    {
      "questionTitle": "Questions 22-23",
      "questionIntro": "Quyidagi joylarni to‘ldiring. Javob sifatida 2 ta so‘zdan ortiq bo‘lmagan so‘z yozing.",
      "questionsTask": [
        {
          "type": "text-multi",
          "numbers": [22, 23],
          "question": "The first feathered fossil was discovered in the province of []. One of the most famous fossil sites is called []."
        }
      ]
    },
    {
      "questionTitle": "Question 24",
      "questionIntro": "To‘g‘ri javobni tanlang.",
      "questionsTask": [
        {
          "number": 24,
          "type": "select",
          "question": "Which of the following creatures is considered the first bird?",
          "options": ["Tyrannosaurus", "Archaeopteryx", "Velociraptor", "Microraptor"]
        }
      ]
    }
  ]
...
{
  "part": "part3",
  "intro": "O‘qishga asoslangan 25-29 savollarga taxminan 15 daqiqa vaqt ajrating.",
  "textTitle": "Adaptations in Marine Reptiles",
  "text": "Marine reptiles such as ichthyosaurs and plesiosaurs adapted various features to thrive in aquatic environments, showcasing evolutionary innovation...",
  "question": [
    {
      "questionTitle": "Questions 25-26",
      "questionIntro": "Quyidagi har bir bayonot uchun to‘g‘ri javobni tanlang.",
      "questionsTask": [
        {
          "number": 25,
          "type": "radio",
          "question": "Ichthyosaurs resembled modern dolphins in body shape.",
          "options": ["TRUE", "FALSE", "NOT GIVEN"]
        },
        {
          "number": 26,
          "type": "radio",
          "question": "Plesiosaurs had long necks to help catch fast-moving prey.",
          "options": ["TRUE", "FALSE", "NOT GIVEN"]
        }
      ]
    },
    {
      "questionTitle": "Questions 27-28",
      "questionIntro": "Quyidagi joylarni to‘ldiring. Javob sifatida 2 ta so‘zdan ortiq bo‘lmagan so‘z yozing.",
      "questionsTask": [
        {
          "type": "text-multi",
          "numbers": [27, 28],
          "question": "Ichthyosaurs were most abundant during the []. Plesiosaurs used their [] for swimming."
        }
      ]
    },
    {
      "questionTitle": "Question 29",
      "questionIntro": "To‘g‘ri javobni tanlang.",
      "questionsTask": [
        {
          "number": 29,
          "type": "select",
          "question": "Which adaptation helped marine reptiles survive underwater?",
          "options": ["Gills", "Fins", "Feathers", "Wings"]
        }
      ]
    }
  ]
